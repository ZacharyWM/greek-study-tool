...
const customActiveStyles = {
  ...
  return (
    <div
      ...
      } ${isHovered || isDragging ? 'bg-blue-50 shadow-md border-0' : 'bg-white/70 border-0'}`}
      style={{
    ...
    >
      ...
      {(isHovered || isDragging) && (
        <div className="absolute -top-1.5 -right-1.5 w-3 h-3 bg-blue-400 rounded-full border border-white" 

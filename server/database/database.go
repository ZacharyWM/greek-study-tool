...
//go:embed books/1_Matthew.json
var matthew []byte

//go:embed books/2_Mark.json
var mark []byte

//go:embed books/27_Revelation.json
var revelation []byte
...
func RunMigrations() {
	...
	*/
	...
	if !bookExists("Revelation") {
		importBook(revelation)
	}
